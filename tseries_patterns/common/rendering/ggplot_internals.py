#
# Internal functions and classes from plotnine package (not exposed)
#
...
from plotnine.facets.labelling import as_labeller
from .utils import ninteraction, add_margins, cross_join, match, join_keys
...
class facet:
    ...
    def __init__(self, scales='fixed', shrink=True,
                 ...
                 drop=True, dir='h', height_ratios = None, width_ratios = None, ):
        self.shrink = shrink
